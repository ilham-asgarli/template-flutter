...
void _userSerialize(
  ...
  writer.writeLong(offsets[3], object.password);
}
...
extension UserQueryFilter on QueryBuilder<User, User, QFilterCondition> {
  ...
  QueryBuilder<User, User, QAfterFilterCondition> passwordEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'password',
        value: value,
...
extension UserQueryWhereDistinct on QueryBuilder<User, User, QDistinct> {
  ...
  QueryBuilder<User, User, QDistinct> distinctByPassword() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'password');
    });
  }
}
...
extension UserQueryProperty on QueryBuilder<User, User, QQueryProperty> {
  ...
  QueryBuilder<User, int, QQueryOperations> passwordProperty() {
    return QueryBuilder.apply(this, (query) {
